...
if __name__ == '__main__':
    ...
    backtesting.backtesting(buy_stop_loss=True, bsl_atr=True, sell_stop_loss=True, ssl_atr=True,
                            buy_take_profit=True, btp_atr=True, sell_take_profit=True, stp_atr=True,
                            buy_trailing_stop=True, bts_atr=True, sell_trailing_stop=True, sts_atr=True,
    ...
    backtesting.data_class.plot_bokeh_indicators(
        ...
        step_indicators={
            'stop_loss_level': 'red',
            'trailing_stop_level': 'orange',
            'take_profit_level': 'green',
        }
    )
