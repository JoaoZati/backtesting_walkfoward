...
if __name__ == '__main__':
    try:
        os.chdir('backtesting_walkfoward/exemples/exemple_ploting_bokeh')
        print('ok')
    except Exception:
        pass
    ...
    backtesting.indicator(bni.moving_avarange_df, 120, 'ma_120')
    backtesting.buy_enter(buy_enter.buy_enter_crossover, 'ma_20', 'ma_120')
    backtesting.sell_enter(sell_enter.sell_enter_crossover, 'ma_20', 'ma_120')

    backtesting.backtesting(revert=True, timeit=True)

    backtesting.data_class.plot_bokeh_indicators(
        line_indicators={'ma_20': 'blue', 'ma_120': 'yellow'},
