...
import pandas as pd
import os
from backtesting_numba.exemples.exemple_numba.exemple_numba import moving_avarange_njit

try:
    os.chdir('backtesting_numba/exemples/exemple_backtesting_indicator')
except Exception:
    pass
